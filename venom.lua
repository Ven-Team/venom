...
DevAbs:sadd(venom..'Abs:VipMem:'..data.chat_id_,dp.id_)
EditMsg(Chat_Id2, Msg_Id2,'⌔︙العضو -› ['..dp.first_name_..'](t.me/'..(dp.username_ or 'VeNoM_Source')..')\n⌔︙تم رفعه في قائمة المميزين')
end,nil)
...
tdcli_function ({ID = "GetUser",user_id_ = AbsId},function(arg,dp) 
DevAbs:sadd(venom..'Abs:Cleaner:'..data.chat_id_,dp.id_)
...
tdcli_function ({ID = "GetUser",user_id_ = AbsId},function(arg,dp) 
DevAbs:sadd(venom..'Abs:Admins:'..data.chat_id_,dp.id_)
...
tdcli_function ({ID = "GetUser",user_id_ = AbsId},function(arg,dp) 
DevAbs:sadd(venom..'Abs:Managers:'..data.chat_id_,dp.id_)
...
tdcli_function ({ID = "GetUser",user_id_ = AbsId},function(arg,dp) 
DevAbs:sadd(venom..'Abs:Constructor:'..data.chat_id_,dp.id_)
...
tdcli_function ({ID = "GetUser",user_id_ = AbsId},function(arg,dp) 
DevAbs:sadd(venom..'Abs:BasicConstructor:'..data.chat_id_,dp.id_)
...
tdcli_function ({ID = "GetUser",user_id_ = AbsId},function(arg,dp) 
DevAbs:sadd(venom..'Abs:AbsConstructor:'..data.chat_id_,dp.id_)
...
tdcli_function ({ID = "GetUser",user_id_ = AbsId},function(arg,dp) 
DevAbs:sadd(venom..'Abs:SudoBot:'..data.chat_id_,dp.id_)
...
tdcli_function ({ID = "GetUser",user_id_ = AbsId},function(arg,dp) 
DevAbs:sadd(venom..'Abs:SecondSudo:'..data.chat_id_,dp.id_)
...
tdcli_function ({ID = "GetUser",user_id_ = AbsId},function(arg,dp) 
DevAbs:srem(venom..'Abs:VipMem:'..data.chat_id_,dp.id_)
...
tdcli_function ({ID = "GetUser",user_id_ = AbsId},function(arg,dp) 
DevAbs:srem(venom..'Abs:Cleaner:'..data.chat_id_,dp.id_)
...
tdcli_function ({ID = "GetUser",user_id_ = AbsId},function(arg,dp) 
DevAbs:srem(venom..'Abs:Admins:'..data.chat_id_,dp.id_)
...
tdcli_function ({ID = "GetUser",user_id_ = AbsId},function(arg,dp) 
DevAbs:srem(venom..'Abs:Managers:'..data.chat_id_,dp.id_)
...
tdcli_function ({ID = "GetUser",user_id_ = AbsId},function(arg,dp) 
DevAbs:srem(venom..'Abs:Constructor:'..data.chat_id_,dp.id_)
...
tdcli_function ({ID = "GetUser",user_id_ = AbsId},function(arg,dp) 
DevAbs:srem(venom..'Abs:BasicConstructor:'..data.chat_id_,dp.id_)
...
tdcli_function ({ID = "GetUser",user_id_ = AbsId},function(arg,dp) 
DevAbs:srem(venom..'Abs:AbsConstructor:'..data.chat_id_,dp.id_)
...
tdcli_function ({ID = "GetUser",user_id_ = AbsId},function(arg,dp) 
DevAbs:srem(venom..'Abs:SudoBot:'..data.chat_id_,dp.id_)
...
tdcli_function ({ID = "GetUser",user_id_ = AbsId},function(arg,dp) 
DevAbs:srem(venom..'Abs:SecondSudo:'..data.chat_id_,dp.id_)
...
DevAbs:sadd(venom..'Abs:Muted:'..data.chat_id_,dp.id_)
EditMsg(Chat_Id2, Msg_Id2,'⌔︙العضو -› ['..dp.first_name_..'](t.me/'..(dp.username_ or 'VeNoM_Source')..')\n⌔︙تم كتمه من المجموعه')
end
end,nil)
...
tdcli_function ({ID = "GetUser",user_id_ = AbsId},function(arg,dp) 
DevAbs:srem(venom..'Abs:Muted:'..data.chat_id_,dp.id_)
...
DevAbs:sadd(venom..'Abs:Ban:'..data.chat_id_,dp.id_)
EditMsg(Chat_Id2, Msg_Id2,'⌔︙العضو -› ['..dp.first_name_..'](t.me/'..(dp.username_ or 'VeNoM_Source')..')\n⌔︙تم حظره من المجموعه')
end
end,nil)
...
tdcli_function ({ID = "GetUser",user_id_ = AbsId},function(arg,dp) 
DevAbs:srem(venom..'Abs:Ban:'..data.chat_id_,dp.id_)
...
DevAbs:sadd(venom..'Abs:Tkeed:'..data.chat_id_,dp.id_)
...
DevAbs:srem(venom..'Abs:Tkeed:'..data.chat_id_,dp.id_)
...
local Text = '⌔︙قم باستعمال الازرار لرفع العضو -› ⤈\n⌔︙العضو -› ['..dp.first_name_..'](t.me/'..(dp.username_ or 'VeNoM_Source')..')'
keyboard = {} 
if Sudo(data) then
keyboard.inline_keyboard = {{{text="رفع مميز",callback_data=data.sender_user_id_..":SetMem:"..AbsId},{text="رفع ادمن",callback_data=data.sender_user_id_..":SetAdmin:"..AbsId}},{{text="رفع منشئ",callback_data=data.sender_user_id_..":SetConstructor:"..AbsId},{text="رفع مدير",callback_data=data.sender_user_id_..":SetManager:"..AbsId}},{{text="رفع منظف",callback_data=data.sender_user_id_..":SetCleaner:"..AbsId},{text="رفع منشئ اساسي",callback_data=data.sender_user_id_..":SetBasicConstructor:"..AbsId}},{{text="رفع مالك",callback_data=data.sender_user_id_..":SetAbsConstructor:"..AbsId},{text="رفع مطور",callback_data=data.sender_user_id_..":SetSudoBot:"..AbsId}},{{text="رفع مطور ثانوي",callback_data=data.sender_user_id_..":SetSecondSudo:"..AbsId}},{{text = '˛ ᴠᴇɴᴏᴍ ѕᴏụʀᴄᴇ.',url="t.me/VeNoM_Source"}}}
elseif SecondSudo(data) then
keyboard.inline_keyboard = {{{text="رفع مميز",callback_data=data.sender_user_id_..":SetMem:"..AbsId},{text="رفع ادمن",callback_data=data.sender_user_id_..":SetAdmin:"..AbsId}},{{text="رفع منشئ",callback_data=data.sender_user_id_..":SetConstructor:"..AbsId},{text="رفع مدير",callback_data=data.sender_user_id_..":SetManager:"..AbsId}},{{text="رفع منظف",callback_data=data.sender_user_id_..":SetCleaner:"..AbsId},{text="رفع منشئ اساسي",callback_data=data.sender_user_id_..":SetBasicConstructor:"..AbsId}},{{text="رفع مالك",callback_data=data.sender_user_id_..":SetAbsConstructor:"..AbsId},{text="رفع مطور",callback_data=data.sender_user_id_..":SetSudoBot:"..AbsId}},{{text = '˛ ᴠᴇɴᴏᴍ ѕᴏụʀᴄᴇ.',url="t.me/VeNoM_Source"}}}
elseif SudoBot(data) then
keyboard.inline_keyboard = {{{text="رفع مميز",callback_data=data.sender_user_id_..":SetMem:"..AbsId},{text="رفع ادمن",callback_data=data.sender_user_id_..":SetAdmin:"..AbsId}},{{text="رفع منشئ",callback_data=data.sender_user_id_..":SetConstructor:"..AbsId},{text="رفع مدير",callback_data=data.sender_user_id_..":SetManager:"..AbsId}},{{text="رفع منظف",callback_data=data.sender_user_id_..":SetCleaner:"..AbsId},{text="رفع منشئ اساسي",callback_data=data.sender_user_id_..":SetBasicConstructor:"..AbsId}},{{text="رفع مالك",callback_data=data.sender_user_id_..":SetAbsConstructor:"..AbsId}},{{text = '˛ ᴠᴇɴᴏᴍ ѕᴏụʀᴄᴇ.',url="t.me/VeNoM_Source"}}}
elseif AbsConstructor(data) then
keyboard.inline_keyboard = {{{text="رفع مميز",callback_data=data.sender_user_id_..":SetMem:"..AbsId},{text="رفع ادمن",callback_data=data.sender_user_id_..":SetAdmin:"..AbsId}},{{text="رفع منشئ",callback_data=data.sender_user_id_..":SetConstructor:"..AbsId},{text="رفع مدير",callback_data=data.sender_user_id_..":SetManager:"..AbsId}},{{text="رفع منظف",callback_data=data.sender_user_id_..":SetCleaner:"..AbsId},{text="رفع منشئ اساسي",callback_data=data.sender_user_id_..":SetBasicConstructor:"..AbsId}},{{text = '˛ ᴠᴇɴᴏᴍ ѕᴏụʀᴄᴇ.',url="t.me/VeNoM_Source"}}}
elseif BasicConstructor(data) then
keyboard.inline_keyboard = {{{text="رفع مميز",callback_data=data.sender_user_id_..":SetMem:"..AbsId},{text="رفع ادمن",callback_data=data.sender_user_id_..":SetAdmin:"..AbsId}},{{text="رفع منشئ",callback_data=data.sender_user_id_..":SetConstructor:"..AbsId},{text="رفع مدير",callback_data=data.sender_user_id_..":SetManager:"..AbsId}},{{text="رفع منظف",callback_data=data.sender_user_id_..":SetCleaner:"..AbsId}},{{text = '˛ ᴠᴇɴᴏᴍ ѕᴏụʀᴄᴇ.',url="t.me/VeNoM_Source"}}}
elseif Constructor(data) then
keyboard.inline_keyboard = {{{text="رفع مميز",callback_data=data.sender_user_id_..":SetMem:"..AbsId},{text="رفع ادمن",callback_data=data.sender_user_id_..":SetAdmin:"..AbsId}},{{text="رفع منظف",callback_data=data.sender_user_id_..":SetCleaner:"..AbsId},{text="رفع مدير",callback_data=data.sender_user_id_..":SetManager:"..AbsId}},{{text = '˛ ᴠᴇɴᴏᴍ ѕᴏụʀᴄᴇ.',url="t.me/VeNoM_Source"}}}
elseif Manager(data) then
keyboard.inline_keyboard = {{{text="رفع مميز",callback_data=data.sender_user_id_..":SetMem:"..AbsId},{text="رفع ادمن",callback_data=data.sender_user_id_..":SetAdmin:"..AbsId}},{{text = '˛ ᴠᴇɴᴏᴍ ѕᴏụʀᴄᴇ.',url="t.me/VeNoM_Source"}}}
elseif Admin(data) then
keyboard.inline_keyboard = {{{text="رفع مميز",callback_data=data.sender_user_id_..":SetMem:"..AbsId}},{{text = '˛ ᴠᴇɴᴏᴍ ѕᴏụʀᴄᴇ.',url="t.me/VeNoM_Source"}}}
end 
...
keyboard = {} 
if Sudo(data) then
keyboard.inline_keyboard = {{{text="تنزيل مميز",callback_data=data.sender_user_id_..":RemMem:"..AbsId},{text="تنزيل ادمن",callback_data=data.sender_user_id_..":RemAdmin:"..AbsId}},{{text="تنزيل منشئ",callback_data=data.sender_user_id_..":RemConstructor:"..AbsId},{text="تنزيل مدير",callback_data=data.sender_user_id_..":RemManager:"..AbsId}},{{text="تنزيل منظف",callback_data=data.sender_user_id_..":RemCleaner:"..AbsId},{text="تنزيل منشئ اساسي",callback_data=data.sender_user_id_..":RemBasicConstructor:"..AbsId}},{{text="تنزيل مالك",callback_data=data.sender_user_id_..":RemAbsConstructor:"..AbsId},{text="تنزيل مطور",callback_data=data.sender_user_id_..":RemSudoBot:"..AbsId}},{{text="تنزيل مطور ثانوي",callback_data=data.sender_user_id_..":RemSecondSudo:"..AbsId}},{{text = '˛ ᴠᴇɴᴏᴍ ѕᴏụʀᴄᴇ.',url="t.me/VeNoM_Source"}}}
elseif SecondSudo(data) then
keyboard.inline_keyboard = {{{text="تنزيل مميز",callback_data=data.sender_user_id_..":RemMem:"..AbsId},{text="تنزيل ادمن",callback_data=data.sender_user_id_..":RemAdmin:"..AbsId}},{{text="تنزيل منشئ",callback_data=data.sender_user_id_..":RemConstructor:"..AbsId},{text="تنزيل مدير",callback_data=data.sender_user_id_..":RemManager:"..AbsId}},{{text="تنزيل منظف",callback_data=data.sender_user_id_..":RemCleaner:"..AbsId},{text="تنزيل منشئ اساسي",callback_data=data.sender_user_id_..":RemBasicConstructor:"..AbsId}},{{text="تنزيل مالك",callback_data=data.sender_user_id_..":RemAbsConstructor:"..AbsId},{text="تنزيل مطور",callback_data=data.sender_user_id_..":RemSudoBot:"..AbsId}},{{text = '˛ ᴠᴇɴᴏᴍ ѕᴏụʀᴄᴇ.',url="t.me/VeNoM_Source"}}}
elseif SudoBot(data) then
keyboard.inline_keyboard = {{{text="تنزيل مميز",callback_data=data.sender_user_id_..":RemMem:"..AbsId},{text="تنزيل ادمن",callback_data=data.sender_user_id_..":RemAdmin:"..AbsId}},{{text="تنزيل منشئ",callback_data=data.sender_user_id_..":RemConstructor:"..AbsId},{text="تنزيل مدير",callback_data=data.sender_user_id_..":RemManager:"..AbsId}},{{text="تنزيل منظف",callback_data=data.sender_user_id_..":RemCleaner:"..AbsId},{text="تنزيل منشئ اساسي",callback_data=data.sender_user_id_..":RemBasicConstructor:"..AbsId}},{{text="تنزيل مالك",callback_data=data.sender_user_id_..":RemAbsConstructor:"..AbsId}},{{text = '˛ ᴠᴇɴᴏᴍ ѕᴏụʀᴄᴇ.',url="t.me/VeNoM_Source"}}}
elseif AbsConstructor(data) then
keyboard.inline_keyboard = {{{text="تنزيل مميز",callback_data=data.sender_user_id_..":RemMem:"..AbsId},{text="تنزيل ادمن",callback_data=data.sender_user_id_..":RemAdmin:"..AbsId}},{{text="تنزيل منشئ",callback_data=data.sender_user_id_..":RemConstructor:"..AbsId},{text="تنزيل مدير",callback_data=data.sender_user_id_..":RemManager:"..AbsId}},{{text="تنزيل منظف",callback_data=data.sender_user_id_..":RemCleaner:"..AbsId},{text="تنزيل منشئ اساسي",callback_data=data.sender_user_id_..":RemBasicConstructor:"..AbsId}},{{text = '˛ ᴠᴇɴᴏᴍ ѕᴏụʀᴄᴇ.',url="t.me/VeNoM_Source"}}}
elseif BasicConstructor(data) then
keyboard.inline_keyboard = {{{text="تنزيل مميز",callback_data=data.sender_user_id_..":RemMem:"..AbsId},{text="تنزيل ادمن",callback_data=data.sender_user_id_..":RemAdmin:"..AbsId}},{{text="تنزيل منشئ",callback_data=data.sender_user_id_..":RemConstructor:"..AbsId},{text="تنزيل مدير",callback_data=data.sender_user_id_..":RemManager:"..AbsId}},{{text="تنزيل منظف",callback_data=data.sender_user_id_..":RemCleaner:"..AbsId}},{{text = '˛ ᴠᴇɴᴏᴍ ѕᴏụʀᴄᴇ.',url="t.me/VeNoM_Source"}}}
elseif Constructor(data) then
keyboard.inline_keyboard = {{{text="تنزيل مميز",callback_data=data.sender_user_id_..":RemMem:"..AbsId},{text="تنزيل ادمن",callback_data=data.sender_user_id_..":RemAdmin:"..AbsId}},{{text="تنزيل منظف",callback_data=data.sender_user_id_..":RemCleaner:"..AbsId},{text="تنزيل مدير",callback_data=data.sender_user_id_..":RemManager:"..AbsId}},{{text = '˛ ᴠᴇɴᴏᴍ ѕᴏụʀᴄᴇ.',url="t.me/VeNoM_Source"}}}
elseif Manager(data) then
keyboard.inline_keyboard = {{{text="تنزيل مميز",callback_data=data.sender_user_id_..":RemMem:"..AbsId},{text="تنزيل ادمن",callback_data=data.sender_user_id_..":RemAdmin:"..AbsId}},{{text = '˛ ᴠᴇɴᴏᴍ ѕᴏụʀᴄᴇ.',url="t.me/VeNoM_Source"}}}
elseif Admin(data) then
keyboard.inline_keyboard = {{{text="تنزيل مميز",callback_data=data.sender_user_id_..":RemMem:"..AbsId}},{{text = '˛ ᴠᴇɴᴏᴍ ѕᴏụʀᴄᴇ.',url="t.me/VeNoM_Source"}}}
end 
https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end,nil)
end
...
⌔︙م6 -› اوامر الاعضاء
━─━─━─ ⌔ ─━─━─━
⌔︙[Source Channel](https://t.me/VeNoM_Source)
]] 
keyboard = {} 
...
if text and text:match('^'..(DevAbs:get(venom..'Abs:NameBot') or "فينوم")..' ') then
data.message_.content_.text_ = data.message_.content_.text_:gsub('^'..(DevAbs:get(venom..'Abs:NameBot') or "فينوم")..' ','')
end
...
Dev_Abs(msg.chat_id_, msg.id_, 1, '⌔︙العضو -› ❨ ['..data.first_name_..'](t.me/'..(data.username_ or 'VeNoM_Source')..')'..' ❩\n⌔︙تم رفعه ❨ '..DEV_ABBAS..' ❩ بنجاح', 1, 'md')
...
if mrabs == "مميز" and VipMem(msg) then
Dev_Abs(msg.chat_id_, msg.id_, 1, '⌔︙العضو -› ❨ ['..result.title_..'](t.me/'..(text1[3] or 'VeNoM_Source')..')'..' ❩\n⌔︙تم رفعه ❨ '..text1[2]..' ❩ بنجاح', 1, 'md')
...
if SecondSudo(msg) then 
local Sudo_Welcome = '⌔︙اهلا بك مجددا عزيزي المطور \n⌔︙اليك الازرار الخاصه بتعديل وتغيير كلايش سورس فينوم فقط اضغط على الامر الذي تريد تنفيذه'
local key = {
...
Dev_Abs(msg.sender_user_id_, msg.id_, 1, '⌔︙تم ارسال رسالتك الى [المطور](t.me/'..(chat.username_ or "VeNoM_Source")..')', 1, 'md') 
...
local venomTEAM = '⌔︙اهلا عزيزي -› '..AbsRank(msg)..' \n⌔︙تم تفعيل التواصل بنجاح'
...
Dev_Abs(msg.chat_id_, msg.id_, 1, '⌔︙عدد اعضاء المجموعه اقل من -› *'..(DevAbs:get(venom..'Abs:Num:Add:Bot') or 0)..'* عضو', 1, 'md')
return false
end
...
if DevAbs:get(venom.."Abs:Text:BotWelcome") then AbsText = DevAbs:get(venom.."Abs:Text:BotWelcome") else AbsText = "⌔︙مرحبا انا بوت اسمي "..NameBot.."\n⌔︙حالة المجموعه -› "..BotText.."\n━─━─━─ ⌔ ─━─━─━" end 
...
local BotName = (DevAbs:get(venom.."Abs:NameBot") or 'فينوم')
...
File:write(GetJson)
File:close()
sendDocument(msg.chat_id_, msg.id_, 0, 1, nil, './'..venom..'.json', '⌔︙يحتوي الملف على -› '..#List..' مجموعه',dl_cb, nil)
...
--     Source venom     --
if text == "الرابط" then
if not DevAbs:get(venom.."Abs:Lock:GpLinksinline"..msg.chat_id_) then 
tdcli_function({ID ="GetChat",chat_id_=msg.chat_id_},function(arg,ta) 
local linkgpp = json:decode(https.request('https://api.telegram.org/bot'..TokenBot..'/exportChatInviteLink?chat_id='..msg.chat_id_)) or DevAbs:get(venom.."Private:Group:Link"..msg.chat_id_) 
...
NameBot = (DevAbs:get(venom..'Abs:NameBot') or 'فينوم')
local venomTEAM = {' كول حبيبي ؟ اني '..NameBot..' ',' وياك القميل '..NameBot..' ',' اسمي القميل '..NameBot..' '}
...
if text and text == (DevAbs:get(venom..'Abs:NameBot') or 'فينوم') then 
NameBot = (DevAbs:get(venom..'Abs:NameBot') or 'فينوم')
local venomTEAM = {'كول حبيبي ؟ اني '..NameBot..' ',' وياك القميل '..NameBot..' '} 
Dev_Abs(msg.chat_id_, msg.id_, 1, venomTEAM[math.random(#venomTEAM)] , 1, 'html') 
return false 
end
...
Dev_Abs(msg.chat_id_, msg.id_, 1,'⌔︙عدد النقاط التي ربحتها -› '..(DevAbs:get(venom..'Abs:GamesNumber'..msg.chat_id_..msg.sender_user_id_)), 1, 'md')
end
end
if text ==  'حذف رسائلي' and ChCheck(msg) or text ==  'مسح رسائلي' and ChCheck(msg) then DevAbs:del(venom..'Abs:UsersMsgs'..msg.chat_id_..':'..msg.sender_user_id_) Dev_Abs(msg.chat_id_, msg.id_, 1, '⌔︙تم حذف جميع رسائلك', 1, 'md') end
if text ==  'حذف نقاطي' and ChCheck(msg) or text ==  'مسح نقاطي' and ChCheck(msg) then DevAbs:del(venom..'Abs:GamesNumber'..msg.chat_id_..msg.sender_user_id_) Dev_Abs(msg.chat_id_, msg.id_, 1, '⌔︙تم حذف جميع نقاطك', 1, 'md') end
--     Source venom     --
...
name = string.gsub(name,'🎚','🎚')
name = string.gsub(name,'☎️','☎️')
venomTEAM = '⌔︙اول واحد يدز هذا السمايل يربح -› '..name
...
venomTEAM = '⌔︙مبروك لقد ربحت في اللعبه \n⌔︙ارسل -› سمايلات للعب مره اخرى'
Dev_Abs(msg.chat_id_, msg.id_, 1,venomTEAM, 1, 'md')
...
venomTEAM = '⌔︙اول واحد يرتبها يربح -› '..name
Dev_Abs(msg.chat_id_, msg.id_, 1,venomTEAM, 1, 'md')
return false
end end
if text == DevAbs:get(venom..'Abs:GameNum'..msg.chat_id_) and not DevAbs:get(venom..'Abs:Games:Ids'..msg.chat_id_) then
...
venomTEAM = '⌔︙اول واحد يحلها يربح -› '..name
Dev_Abs(msg.chat_id_, msg.id_, 1,venomTEAM, 1, 'md')
return false
end end
if text == DevAbs:get(venom..'Abs:GameNum'..msg.chat_id_) and not DevAbs:get(venom..'Abs:Games:Ids'..msg.chat_id_) then
...
venomTEAM = '⌔︙ما معنى هذا السمايل :؟ -› '..name
Dev_Abs(msg.chat_id_, msg.id_, 1,venomTEAM, 1, 'md')
return false
end end
...
name = string.gsub(name,'👩‍⚖️','👨‍⚖️👨‍⚖️👨‍⚖️👨‍⚖️👨‍⚖️👩‍⚖️👨‍⚖️👨‍⚖️')
name = string.gsub(name,'👨‍🎨','👩‍🎨👩‍🎨👨‍🎨👩‍🎨👩‍🎨👩‍🎨👩‍🎨👩‍🎨')
venomTEAM = '⌔︙اول واحد يطلع المختلف يربح\n{'..name..'} '
Dev_Abs(msg.chat_id_, msg.id_, 1,venomTEAM, 1, 'md')
return false
end end
...
venomTEAM = '⌔︙اكمل المثال التالي -› ['..name..']'
Dev_Abs(msg.chat_id_, msg.id_, 1,venomTEAM, 1, 'md')
return false
end end
...
venomTEAM = '⌔︙اكمل المعادله التاليه -› ⤈\n{'..name..'} '
Dev_Abs(msg.chat_id_, msg.id_, 1,venomTEAM, 1, 'md')
return false
end end
...
if not DevAbs:get(venom..'Abs:Lock:Gamesinline'..msg.chat_id_) then
Text =[[
...
{{text = '˛ ᴠᴇɴᴏᴍ ѕᴏụʀᴄᴇ.',url="t.me/VeNoM_Source"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..TokenBot..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
return false
...
Dev_Abs(msg.chat_id_, msg.id_, 1,'⌔︙تم بيع '..(DevAbs:get(venom..'Abs:GamesNumber'..msg.chat_id_..msg.sender_user_id_))..' من نقاطك\n⌔︙كل نقطه تساوي 50 رساله', 'md')
...
Text = "رابط الحذف في جميع مواقع التواصل فكر قبل لا تتسرع وتروح"
keyboard = {} 
keyboard.inline_keyboard = {
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..TokenBot..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
return false
end
...
if text == 'مسح سحكاتي' or text == 'مسح تعديلاتي' or text == 'حذف سحكاتي' or text == 'حذف تعديلاتي' then DevAbs:del(venom..'Abs:EditMsg'..msg.chat_id_..msg.sender_user_id_) Dev_Abs(msg.chat_id_, msg.id_, 1, '⌔︙تم حذف جميع تعديلاتك بنجاح' , 1, 'md') end
if text == 'مسح جهاتي' or text == 'مسح اضافاتي' or text == 'حذف جهاتي' or text == 'حذف اضافاتي' then DevAbs:del(venom..'Abs:ContactNumber'..msg.chat_id_..':'..msg.sender_user_id_) Dev_Abs(msg.chat_id_, msg.id_, 1, '⌔︙تم حذف جميع جهاتك المضافه' , 1, 'md') end
--     Source venom     --
if text == "المطور" then 
local DevText = DevAbs:get(venom.."DevText")
if DevAbs:get(venom.."Abs:ChId") then local Check = https.request('https://api.telegram.org/bot'..TokenBot..'/getChat?chat_id='..DevAbs:get(venom.."Abs:ChId")) local GetInfo = JSON.decode(Check) local DevCh1 = GetInfo.result.username DevCh = '\n⌔︙*Dev Ch* ↬ [@'..DevCh1..']' else DevCh = '' end
...
keyboard = {} 
keyboard.inline_keyboard = {{{text=dp.first_name_,url=("t.me/"..dp.username_ or "t.me/VeNoM_Source")}}}
local msg_id = msg.id_/2097152/0.5
...
local Text = '⌔︙قم باستعمال الازرار لرفع العضو -› ⤈\n⌔︙العضو -› ['..dp.first_name_..'](t.me/'..(dp.username_ or 'VeNoM_Source')..')'
if Sudo(msg) then
inline = {{{text="رفع مميز",callback_data=msg.sender_user_id_..":SetMem:"..result.sender_user_id_},{text="رفع ادمن",callback_data=msg.sender_user_id_..":SetAdmin:"..result.sender_user_id_}},{{text="رفع منشئ",callback_data=msg.sender_user_id_..":SetConstructor:"..result.sender_user_id_},{text="رفع مدير",callback_data=msg.sender_user_id_..":SetManager:"..result.sender_user_id_}},{{text="رفع منظف",callback_data=msg.sender_user_id_..":SetCleaner:"..result.sender_user_id_},{text="رفع منشئ اساسي",callback_data=msg.sender_user_id_..":SetBasicConstructor:"..result.sender_user_id_}},{{text="رفع مالك",callback_data=msg.sender_user_id_..":SetAbsConstructor:"..result.sender_user_id_},{text="رفع مطور",callback_data=msg.sender_user_id_..":SetSudoBot:"..result.sender_user_id_}},{{text="رفع مطور ثانوي",callback_data=msg.sender_user_id_..":SetSecondSudo:"..result.sender_user_id_}},{{text = '˛ ᴠᴇɴᴏᴍ ѕᴏụʀᴄᴇ.',url="t.me/VeNoM_Source"}}}
elseif SecondSudo(msg) then
inline = {{{text="رفع مميز",callback_data=msg.sender_user_id_..":SetMem:"..result.sender_user_id_},{text="رفع ادمن",callback_data=msg.sender_user_id_..":SetAdmin:"..result.sender_user_id_}},{{text="رفع منشئ",callback_data=msg.sender_user_id_..":SetConstructor:"..result.sender_user_id_},{text="رفع مدير",callback_data=msg.sender_user_id_..":SetManager:"..result.sender_user_id_}},{{text="رفع منظف",callback_data=msg.sender_user_id_..":SetCleaner:"..result.sender_user_id_},{text="رفع منشئ اساسي",callback_data=msg.sender_user_id_..":SetBasicConstructor:"..result.sender_user_id_}},{{text="رفع مالك",callback_data=msg.sender_user_id_..":SetAbsConstructor:"..result.sender_user_id_},{text="رفع مطور",callback_data=msg.sender_user_id_..":SetSudoBot:"..result.sender_user_id_}},{{text = '˛ ᴠᴇɴᴏᴍ ѕᴏụʀᴄᴇ.',url="t.me/VeNoM_Source"}}}
elseif SudoBot(msg) then
inline = {{{text="رفع مميز",callback_data=msg.sender_user_id_..":SetMem:"..result.sender_user_id_},{text="رفع ادمن",callback_data=msg.sender_user_id_..":SetAdmin:"..result.sender_user_id_}},{{text="رفع منشئ",callback_data=msg.sender_user_id_..":SetConstructor:"..result.sender_user_id_},{text="رفع مدير",callback_data=msg.sender_user_id_..":SetManager:"..result.sender_user_id_}},{{text="رفع منظف",callback_data=msg.sender_user_id_..":SetCleaner:"..result.sender_user_id_},{text="رفع منشئ اساسي",callback_data=msg.sender_user_id_..":SetBasicConstructor:"..result.sender_user_id_}},{{text="رفع مالك",callback_data=msg.sender_user_id_..":SetAbsConstructor:"..result.sender_user_id_}},{{text = '˛ ᴠᴇɴᴏᴍ ѕᴏụʀᴄᴇ.',url="t.me/VeNoM_Source"}}}
elseif AbsConstructor(msg) then
inline = {{{text="رفع مميز",callback_data=msg.sender_user_id_..":SetMem:"..result.sender_user_id_},{text="رفع ادمن",callback_data=msg.sender_user_id_..":SetAdmin:"..result.sender_user_id_}},{{text="رفع منشئ",callback_data=msg.sender_user_id_..":SetConstructor:"..result.sender_user_id_},{text="رفع مدير",callback_data=msg.sender_user_id_..":SetManager:"..result.sender_user_id_}},{{text="رفع منظف",callback_data=msg.sender_user_id_..":SetCleaner:"..result.sender_user_id_},{text="رفع منشئ اساسي",callback_data=msg.sender_user_id_..":SetBasicConstructor:"..result.sender_user_id_}},{{text = '˛ ᴠᴇɴᴏᴍ ѕᴏụʀᴄᴇ.',url="t.me/VeNoM_Source"}}}
elseif BasicConstructor(msg) then
inline = {{{text="رفع مميز",callback_data=msg.sender_user_id_..":SetMem:"..result.sender_user_id_},{text="رفع ادمن",callback_data=msg.sender_user_id_..":SetAdmin:"..result.sender_user_id_}},{{text="رفع منشئ",callback_data=msg.sender_user_id_..":SetConstructor:"..result.sender_user_id_},{text="رفع مدير",callback_data=msg.sender_user_id_..":SetManager:"..result.sender_user_id_}},{{text="رفع منظف",callback_data=msg.sender_user_id_..":SetCleaner:"..result.sender_user_id_}},{{text = '˛ ᴠᴇɴᴏᴍ ѕᴏụʀᴄᴇ.',url="t.me/VeNoM_Source"}}}
elseif Constructor(msg) then
inline = {{{text="رفع مميز",callback_data=msg.sender_user_id_..":SetMem:"..result.sender_user_id_},{text="رفع ادمن",callback_data=msg.sender_user_id_..":SetAdmin:"..result.sender_user_id_}},{{text="رفع منظف",callback_data=msg.sender_user_id_..":SetCleaner:"..result.sender_user_id_},{text="رفع مدير",callback_data=msg.sender_user_id_..":SetManager:"..result.sender_user_id_}},{{text = '˛ ᴠᴇɴᴏᴍ ѕᴏụʀᴄᴇ.',url="t.me/VeNoM_Source"}}}
elseif Manager(msg) then
inline = {{{text="رفع مميز",callback_data=msg.sender_user_id_..":SetMem:"..result.sender_user_id_},{text="رفع ادمن",callback_data=msg.sender_user_id_..":SetAdmin:"..result.sender_user_id_}},{{text = '˛ ᴠᴇɴᴏᴍ ѕᴏụʀᴄᴇ.',url="t.me/VeNoM_Source"}}}
elseif Admin(msg) then
inline = {{{text="رفع مميز",callback_data=msg.sender_user_id_..":SetMem:"..result.sender_user_id_}},{{text = '˛ ᴠᴇɴᴏᴍ ѕᴏụʀᴄᴇ.',url="t.me/VeNoM_Source"}}}
end
...
local Text = '⌔︙قم باستعمال الازرار لتنزيل العضو -› ⤈\n⌔︙العضو -› ['..dp.first_name_..'](t.me/'..(dp.username_ or 'VeNoM_Source')..')'
if Sudo(msg) then
inline = {{{text="تنزيل مميز",callback_data=msg.sender_user_id_..":RemMem:"..result.sender_user_id_},{text="تنزيل ادمن",callback_data=msg.sender_user_id_..":RemAdmin:"..result.sender_user_id_}},{{text="تنزيل منشئ",callback_data=msg.sender_user_id_..":RemConstructor:"..result.sender_user_id_},{text="تنزيل مدير",callback_data=msg.sender_user_id_..":RemManager:"..result.sender_user_id_}},{{text="تنزيل منظف",callback_data=msg.sender_user_id_..":RemCleaner:"..result.sender_user_id_},{text="تنزيل منشئ اساسي",callback_data=msg.sender_user_id_..":RemBasicConstructor:"..result.sender_user_id_}},{{text="تنزيل مالك",callback_data=msg.sender_user_id_..":RemAbsConstructor:"..result.sender_user_id_},{text="تنزيل مطور",callback_data=msg.sender_user_id_..":RemSudoBot:"..result.sender_user_id_}},{{text="تنزيل مطور ثانوي",callback_data=msg.sender_user_id_..":RemSecondSudo:"..result.sender_user_id_}},{{text = '˛ ᴠᴇɴᴏᴍ ѕᴏụʀᴄᴇ.',url="t.me/VeNoM_Source"}}}
elseif SecondSudo(msg) then
inline = {{{text="تنزيل مميز",callback_data=msg.sender_user_id_..":RemMem:"..result.sender_user_id_},{text="تنزيل ادمن",callback_data=msg.sender_user_id_..":RemAdmin:"..result.sender_user_id_}},{{text="تنزيل منشئ",callback_data=msg.sender_user_id_..":RemConstructor:"..result.sender_user_id_},{text="تنزيل مدير",callback_data=msg.sender_user_id_..":RemManager:"..result.sender_user_id_}},{{text="تنزيل منظف",callback_data=msg.sender_user_id_..":RemCleaner:"..result.sender_user_id_},{text="تنزيل منشئ اساسي",callback_data=msg.sender_user_id_..":RemBasicConstructor:"..result.sender_user_id_}},{{text="تنزيل مالك",callback_data=msg.sender_user_id_..":RemAbsConstructor:"..result.sender_user_id_},{text="تنزيل مطور",callback_data=msg.sender_user_id_..":RemSudoBot:"..result.sender_user_id_}},{{text = '˛ ᴠᴇɴᴏᴍ ѕᴏụʀᴄᴇ.',url="t.me/VeNoM_Source"}}}
elseif SudoBot(msg) then
inline = {{{text="تنزيل مميز",callback_data=msg.sender_user_id_..":RemMem:"..result.sender_user_id_},{text="تنزيل ادمن",callback_data=msg.sender_user_id_..":RemAdmin:"..result.sender_user_id_}},{{text="تنزيل منشئ",callback_data=msg.sender_user_id_..":RemConstructor:"..result.sender_user_id_},{text="تنزيل مدير",callback_data=msg.sender_user_id_..":RemManager:"..result.sender_user_id_}},{{text="تنزيل منظف",callback_data=msg.sender_user_id_..":RemCleaner:"..result.sender_user_id_},{text="تنزيل منشئ اساسي",callback_data=msg.sender_user_id_..":RemBasicConstructor:"..result.sender_user_id_}},{{text="تنزيل مالك",callback_data=msg.sender_user_id_..":RemAbsConstructor:"..result.sender_user_id_}},{{text = '˛ ᴠᴇɴᴏᴍ ѕᴏụʀᴄᴇ.',url="t.me/VeNoM_Source"}}}
elseif AbsConstructor(msg) then
inline = {{{text="تنزيل مميز",callback_data=msg.sender_user_id_..":RemMem:"..result.sender_user_id_},{text="تنزيل ادمن",callback_data=msg.sender_user_id_..":RemAdmin:"..result.sender_user_id_}},{{text="تنزيل منشئ",callback_data=msg.sender_user_id_..":RemConstructor:"..result.sender_user_id_},{text="تنزيل مدير",callback_data=msg.sender_user_id_..":RemManager:"..result.sender_user_id_}},{{text="تنزيل منظف",callback_data=msg.sender_user_id_..":RemCleaner:"..result.sender_user_id_},{text="تنزيل منشئ اساسي",callback_data=msg.sender_user_id_..":RemBasicConstructor:"..result.sender_user_id_}},{{text = '˛ ᴠᴇɴᴏᴍ ѕᴏụʀᴄᴇ.',url="t.me/VeNoM_Source"}}}
elseif BasicConstructor(msg) then
inline = {{{text="تنزيل مميز",callback_data=msg.sender_user_id_..":RemMem:"..result.sender_user_id_},{text="تنزيل ادمن",callback_data=msg.sender_user_id_..":RemAdmin:"..result.sender_user_id_}},{{text="تنزيل منشئ",callback_data=msg.sender_user_id_..":RemConstructor:"..result.sender_user_id_},{text="تنزيل مدير",callback_data=msg.sender_user_id_..":RemManager:"..result.sender_user_id_}},{{text="تنزيل منظف",callback_data=msg.sender_user_id_..":RemCleaner:"..result.sender_user_id_}},{{text = '˛ ᴠᴇɴᴏᴍ ѕᴏụʀᴄᴇ.',url="t.me/VeNoM_Source"}}}
elseif Constructor(msg) then
inline = {{{text="تنزيل مميز",callback_data=msg.sender_user_id_..":RemMem:"..result.sender_user_id_},{text="تنزيل ادمن",callback_data=msg.sender_user_id_..":RemAdmin:"..result.sender_user_id_}},{{text="تنزيل منظف",callback_data=msg.sender_user_id_..":RemCleaner:"..result.sender_user_id_},{text="تنزيل مدير",callback_data=msg.sender_user_id_..":RemManager:"..result.sender_user_id_}},{{text = '˛ ᴠᴇɴᴏᴍ ѕᴏụʀᴄᴇ.',url="t.me/VeNoM_Source"}}}
elseif Manager(msg) then
inline = {{{text="تنزيل مميز",callback_data=msg.sender_user_id_..":RemMem:"..result.sender_user_id_},{text="تنزيل ادمن",callback_data=msg.sender_user_id_..":RemAdmin:"..result.sender_user_id_}},{{text = '˛ ᴠᴇɴᴏᴍ ѕᴏụʀᴄᴇ.',url="t.me/VeNoM_Source"}}}
elseif Admin(msg) then
inline = {{{text="تنزيل مميز",callback_data=msg.sender_user_id_..":RemMem:"..result.sender_user_id_}},{{text = '˛ ᴠᴇɴᴏᴍ ѕᴏụʀᴄᴇ.',url="t.me/VeNoM_Source"}}}
end
SendInline(msg.chat_id_,Text,nil,inline,msg.id_/2097152/0.5)
end,nil)
end 
...
if text == 'تحويل' and not DevAbs:get(venom..'Abs:Thwel:Abs'..msg.chat_id_) and ChCheck(msg) then  
if tonumber(msg.reply_to_message_id_) > 0 then 
...
sudobot = '\n⌔︙عدد الكروبات -› '..(DevAbs:get(venom..'Abs:Sudos'..result.sender_user_id_) or 0)..'' 
else 
sudobot = '' 
end
...
sudobot = '\n⌔︙عدد الكروبات -› '..(DevAbs:get(venom..'Abs:Sudos'..res.id_) or 0)..'' 
else 
sudobot = '' 
end
...
sudobot = '\n⌔︙عدد الكروبات -› '..(DevAbs:get(venom..'Abs:Sudos'..iduser) or 0)..'' 
else 
sudobot = '' 
end
...
Dev_Abs(msg.chat_id_, msg.id_, 1,'⌔︙عدد الكروبات الان -› { '..#group..' }'..venomgp1..venomgp2..'\n⌔︙العدد الحقيقي الان  -› ( '..venomgp3..' ) \n ', 1, 'md')
end end
end,nil)
end
return false
...
if M ~= 0 then
Dev_Abs(msg.chat_id_, msg.id_, 1, "⌔︙عدد الميديا -› "..M.."\n⌔︙الحذف التلقائي -› "..(DevAbs:get(venom..'Abs:CleanNum'..msg.chat_id_) or 200), 1, 'md') 
else
...
if text and text:match("^انطق (.*)$") and not DevAbs:get(venom..'Abs:Antk:Abs'..msg.chat_id_) and ChCheck(msg) then
...
if text == "غنيلي" and not DevAbs:get(venom..'Abs:Audios:Abs'..msg.chat_id_) and ChCheck(msg) then
...
if text and (text == "متحركه" or text == "-› متحركه ᥀") and not DevAbs:get(venom..'Abs:gif:Abs'..msg.chat_id_) and SourceCh(msg) then
...
sendDocument(msg.chat_id_, msg.id_, 0, 1, nil, './venom.lua', '⌔︙نسخة ملف سورس فينوم',dl_cb, nil)
end end
--     Source venom     --
...
Dev_Abs(msg.chat_id_, msg.id_, 1, '⌔︙جاري تحديث سورس فينوم', 1, 'md') 
os.execute('rm -rf venom.lua') 
os.execute('wget https://raw.githubusercontent.com/Ven-Team/venom/master/venom.lua') 
dofile('venom.lua') 
...
local Get_Files, res = https.request("https://raw.githubusercontent.com/Ven-Team/venomFiles/master/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n⌔︙قائمة ملفات متجر سورس فينوم\n⌔︙الملفات المتوفره حاليا -› ⤈\n━─━─━─ ⌔ ─━─━─━\n"
...
local GetJson, Res = https.request("https://raw.githubusercontent.com/Ven-Team/venomFiles/master/LaricAFiles/"..FileName)
if Res == 200 then
...
Dev_Abs(msg.chat_id_, msg.id_, 1, '⌔︙Channel ↬ [@VeNoM_Source]', 1, 'md')    
end 
--     Source venom     --
